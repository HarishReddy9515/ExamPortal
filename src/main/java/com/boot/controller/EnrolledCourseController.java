...
public class EnrolledCourseController {
	...
	public ResponseEntity<EnrolledCourseDTO> addenrolledCourse(@Valid @RequestBody EnrolledCourseDTO enroledCoursesDTO)
	{
		EnrolledCourseDTO enrolledCourse =this.enrolledCourseService.addenrolledCourse(enroledCoursesDTO);
	    return new ResponseEntity<EnrolledCourseDTO>(enroledCoursesDTO,HttpStatus.CREATED);
	}
